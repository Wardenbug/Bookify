...
public class SearchApartmentsTests : BaseIntegrationTest
{
    ...
    [Fact]
    public async Task SearchApartmets_ShouldReturnEmptyList_WhenDateRangeIsInvalid()
    {
        // Arrange
    ...
    [Fact]
    public async Task SearchApartmets_ShouldReturnApartments_WhenDateRangeIsValid()
    {
        // Arrange
